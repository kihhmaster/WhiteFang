...
core.use([Pagination, Scrollbar, Navigation, Controller, Autoplay, Mousewheel, Parallax, EffectFade, EffectCoverflow]);
document.addEventListener('DOMContentLoaded', function () {
  var mainSlider = new core(".main__slider", {
    direction: "vertical",
    loop: false,
    speed: 1000,
    parallax: true,
  ...
  var SliderText = new core(".slider__text", {
    direction: "vertical",
    loop: false,
    speed: 1500,
    parallax: true,

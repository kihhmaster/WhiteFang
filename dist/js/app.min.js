...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var overlayClase = document.querySelector(".overlay__clase");
  ...
  if (overlayClase !== null) {
    overlayClase.addEventListener("click", function () {
  ...
  var aboutUs = new core(".aboutUs", (_Swiper = {
    direction: "vertical",
    speed: 1000,
    pagination: {
      el: ".swiper-pagination",
    ...
    effect: 'creative'
  }, _defineProperty(_Swiper, "effect", 'fade'), _defineProperty(_Swiper, "fadeEffect", {
    crossFade: true
  }), _defineProperty(_Swiper, "navigation", {
    nextEl: ".swiper-button-next__aboutUs",
    prevEl: ".swiper-button-prev__aboutUs"
  }), _defineProperty(_Swiper, "mousewheel", true), _defineProperty(_Swiper, "on", {
  ...
  function tabSlider(idexSlide) {
    ...
    console.log(sectionCenterImg);
    console.log(startDescElementRight);
